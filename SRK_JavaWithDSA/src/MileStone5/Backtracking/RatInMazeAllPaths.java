...
*/
package MileStone5.Backtracking;
...
public class RatInMazeAllPaths {
	...
	static void ratInAMaze(int maze[][], int n) {
		 ...
		 */
		 ...
		 ratInAMaze(maze, n,path,0,0);

	}
	static void ratInAMaze(int maze[][],int n,int path[][],int i,int j){
		...
		ratInAMaze(maze, n,path,i-1,j);
		ratInAMaze(maze, n,path,i,j+1);
		ratInAMaze(maze, n,path,i+1,j);
		ratInAMaze(maze, n,path,i,j-1);
		path[i][j]=0;
	}
