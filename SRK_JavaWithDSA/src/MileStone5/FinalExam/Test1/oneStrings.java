...
In the given test case, there are 3 required substrings of length 1, at indices, 0, 1, and 2. 
There are 2 required substrings of length 2, starting at indices, 0 and 1. 
There is also a required substring of length 3 starting at index 0. 
...
package MileStone5.FinalExam.Test1;
	...
	static int findOneStrings(String s)
	{
		int res = 0, count = 0;
	...
	public static void main(String[] args)
	{
		...
		System.out.println(findOneStrings(s));
	}
	}
